...
> 本篇是《深入 Claude Code CLI 源码》系列的第 3 篇。我们将深入分析 Claude Code 如何用一个 35 行的极简 Store 实现，桥接 React UI 与非 React 业务逻辑之间的状态管理，并理解三层状态架构的设计哲学。

## 为什么状态管理值得单独一篇？

Claude Code CLI 面临一个独特的状态管理难题：它**既是一个 React 应用，又不完全是**。
...
[第 4 篇：System Prompt 工程 — 精密控制模型行为的提示词体系](./04-System-Prompt工程.md)
